...
class SubWindow(QMainWindow):
    def __init__(self, parent=None, mode=None, default=None):
        ...
        if mode == 'worker':
            radio_widget = RadioButtonWidget.worker_widget(val=default)
        elif mode == 'work_shift':
            radio_widget = RadioButtonWidget.work_shift_widget(val=default)
        elif mode == 'assistant':
            radio_widget = RadioButtonWidget.assistant_widget(val=default)
        else:
            return
...
class DBWindow(QMainWindow):
    def __init__(self, parent=None, mode=None):
        ...
        if mode == 'register':
            file_widget = FileWidget.init_db_register_widget()
        elif mode == 'edit/view':
            file_widget = FileWidget.init_db_edit_widget()
        elif mode == 'delete':
            file_widget = FileWidget.init_db_delete_widget()
        else:
            return
